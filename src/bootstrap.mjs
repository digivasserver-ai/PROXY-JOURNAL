...
function buildShortPack(home, core) {
  ...
  // Integrity fingerprint for tamper detection
  let fingerprint = ''
  try {
    const fp = generateFingerprint(home)
    if (fp) fingerprint = `\n**Integrity:** \`${fp}\``
...
*PROXY JOURNAL · DIGIVASCONNECT · v1.2.0 · hop mode · ${new Date().toISOString().slice(0, 19)}Z*
`
...
*Generated by PROXY JOURNAL · DIGIVASCONNECT PTY (LTD) · v1.2.0*
